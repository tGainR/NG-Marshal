        ...
        <div className="max-w-6xl mx-auto px-5 py-3 flex flex-wrap justify-between items-center gap-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <label
              ...
              title="Upload import pendency / export cutoff / ITV master / driver master — Excel or CSV. Data is added and updated, never overwritten."
            ...
            <div className="bg-white border border-[#D8DEE7] rounded-xl p-4 flex flex-col gap-3">
              <div className="flex flex-wrap justify-between items-center gap-2">
                ...
                <span className="text-[10.5px] font-bold text-[#177A47] bg-[#E3F4EB] rounded-full px-2.5 py-1">
                  In system: {livePool(state.pool).filter((c) => (c.direction ?? "import") === "import").length} import · {livePool(state.pool).filter((c) => c.direction === "export").length} export containers · {state.pool.filter((c) => c.status === "cleared").length} cleared
                </span>
              </div>
